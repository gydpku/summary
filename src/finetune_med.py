...
import torch
import pdb
data_path='/dccstor/obsidian_llm/yiduo/lsf/llama-recipes/src/llama_recipes/datasets/all_task_0.5_0.5_val_general_mimic_while' #'/dccstor/obsidian_llm/yiduo/output_first' 
...
model_path='/dccstor/obsidian_llm/yiduo/llama_3.1' #'/dccstor/obsidian_llm/yiduo/h100_data/llama-3-8b' #'/dccstor/obsidian_llm/yiduo/gemma_2_9b'
output_path='/dccstor/obsidian_llm/yiduo/copy_v2/finetuned_models/llama-3.1-med_2048' ##output_first_3_model' #llama-3-8b-hug-zero-shot-ep-peft-5e-2' #'/dccstor/obsidian_llm/yiduo/gemma_2_9b_1e-5_0.5'
tokenizer = AutoTokenizer.from_pretrained(model_path)
'''
